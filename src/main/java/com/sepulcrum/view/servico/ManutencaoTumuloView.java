...
public class ManutencaoTumuloView extends JFrame{
    protected JButton jbSalvar, jbCancelar;
    protected JTextField jtfOne, jtfTwo, jtfFour, jtfFive, jtfSix, jtfSeven, jtfEight, jtfNine;
    ...
    public ManutencaoTumuloView(int seletor, int seletorCrud, int id){
            ...
            switch(index){
                case 0 -> {
                    if(seletorCrud == 1){
                        ...
                        mtc.updateManutencaoTumulo(this, id);
                        msgAlterada();
